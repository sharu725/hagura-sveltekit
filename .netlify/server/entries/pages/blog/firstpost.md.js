...
var import_BlogLayout_fab098a8 = __toModule(require("../../../chunks/BlogLayout-fab098a8.js"));
const Counter = (0, import_index_7cb4dd95.c)(($$result, $$props, $$bindings, slots) => {
  let count = 42;
  return `<button class="${"bg-green-500 hover:bg-green-600 rounded px-4 py-1 my-4 text-white"}">Count: ${(0, import_index_7cb4dd95.e)(count)}</button>`;
});
const metadata = {
  "layout": "blog",
  "title": "First post",
...
const Firstpost = (0, import_index_7cb4dd95.c)(($$result, $$props, $$bindings, slots) => {
  return `${(0, import_index_7cb4dd95.v)(import_BlogLayout_fab098a8.B, "Layout_MDSVEX_DEFAULT").$$render($$result, Object.assign($$props, metadata), {}, {
    default: () => {
...
${(0, import_index_7cb4dd95.v)(Counter, "Counter").$$render($$result, {}, {}, {})}
